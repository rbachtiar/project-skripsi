                        ...
                        <nav class="navbar h-100 navbar-expand-lg align-items-center">
                            ...
                            <div class="collapse navbar-collapse justify-content-end" id="olv-navbar">
                                <ul class="navbar-nav animated" id="nav">
                                    <li class="nav-item active"><a class="nav-link" href="{{url("konsultasi")}}">Home</a></li>
                              ...
                              <table data-vertable="ver6">
                               <thead>
                                <tr class="row100 head">
                                 ...
                                 <th class="column100 column3" data-column="column3">PERNYAKIT</th>
                                 <th class="column100 column3" data-column="column3">INFO</th>
                                 <th class="column100 column3" data-column="column3">SOLUSI</th>
                                </tr>
                               </thead>
                               <tbody>
                                <tr class="row100">
